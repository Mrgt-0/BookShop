...
public class Builder {
    ...
    public Menu buildAdminMenu(Navigator navigator){
        MenuItem addBookMenuItem=new MenuItem("Добавить книгу", ()->navigator.navigate(buildAddBookMenu()));
        MenuItem removeBookMenuItem=new MenuItem("Удалить книгу", ()->navigator.navigate(buildRemoveBookMenu()));
        MenuItem[] items={
                new MenuItem("Посмотреть все книги", ()->displayBookMenu(bookStore.getBookInventory())),
