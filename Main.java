...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //BookStoreController.Exporter exporter=new BookStoreController.Exporter();
        //BookStoreController.Importer importer=new BookStoreController.Importer();
        //importer.booksImporter("C:\\Users\\Trita\\OneDrive\\Документы\\test.csv");
//        for (Book book : importer.booksImporter("C:\\Users\\Trita\\OneDrive\\Документы\\test.csv")){
